...
package com.steeshock.android.streetworkout.services
...
class FetchAddressIntentService : IntentService("FetchAddress") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        // Errors could still arise from using the Geocoder (for steeshock, if there is no
        ...
        if (addresses.isEmpty()) {
            ...
            // getLocality() ("Mountain View", for steeshock)
            // getAdminArea() ("CA", for steeshock)
            // getPostalCode() ("94043", for steeshock)
            // getCountryCode() ("US", for steeshock)
            // getCountryName() ("United States", for steeshock)
